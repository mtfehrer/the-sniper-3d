...
class Game(Ursina):
	def __init__(self):
		...
		self.scope_filter = Entity(parent=camera, model="quad", texture="circle at center.png", scale=(1, 0.8, 0.8), position=(0, 0, 1), visible=False)
		self.sniper_sound = Audio("sniper sound effect.mp3", autoplay=False)
